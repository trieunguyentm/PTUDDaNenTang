...
import { updateImgGroupHasJoin, updateImgManage } from "../redux/group"
import { uploadImageGroup } from "../api/apiUploadImageGroup"

const screenWidth = Dimensions.get("window").width
const screenHeight = Dimensions.get("window").height

const PageGroupManage = ({ route, navigation }) => {
  ...
  const group = useSelector((state) =>
    state.group.groupManage.find((item) => item.id == groupId),
  )
      ...
      <SafeAreaView style={{ flex: 1 }}>
        <View style={styles.contentContainer}>
          ...
          <View style={styles.btnContainer}>
            <View style={styles.btnCheckAdmin}></View>
            <View style={styles.btnLeave}></View>
...
export default PageGroupManage
